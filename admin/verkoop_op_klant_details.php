...
$queryP100 = mysql_query("SELECT users_pro_company, users_pro_password FROM users_pro WHERE users_pro_password = '".$_GET['id']."'");
...
if($queryP100Num>0) {
    ...
    print "<tr height='30'>";
    print "<td align='center' valign='middle' colspan='".$colspan."'><b><a href='klant_fiche.php?action=view&id=".$providerNum."'>".$providerName."</a> | Klant: ".$providerNum."</b></td></tr><tr>";
    
        print "<td align='left' class='TD'><b>".FACT."</b></td>";
            print "<td align='center' class='TD'><b>NIC</b></td>";
        ...
        while($rowUp = mysql_fetch_array($queryP)) {
        								...
        								foreach ($splitUp as $item) {
        								    $check = explode("+",$item);
                                                ...
                                                if(empty($check[6])) {
                                                    print "<td valign='top align='left'>X</td>";}
                                                else {
                                                    ...
                                                    print "<td valign='top align='left'>".$optDisplay."</td>";
                                                }
                                                print "</tr>";
    ...
    print "<p align='center' class='fontrouge'><b>".B350." '".$providerName."'.</b></p>";
}
}
else {
      print "<p align='center'>";
    ...
    print "<form action='verkoop_op_klant.php'><p align='center'><input type='submit' value='".BACK."' class='knop'></p></form>";
?>
<br><br><br>
</body>
</html>

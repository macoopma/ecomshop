...
<?php
$categQuery = mysql_query("SELECT export_auto_twenga FROM admin");
$categ = mysql_fetch_array($categQuery);

if(!empty($categ['export_auto_twenga'])) {
            $cat = $categ['export_auto_twenga'];
            $cat = explode("||", $categ['export_auto_twenga']);

    ...
    if($tab[$x][1]==$pere) {
       ...
       print espace3($rang3).$tab[$x][2];
               ...
               while($produit = mysql_fetch_array($result3)) {
                ...
                $rupture = ($produit['products_qt']<=0)? "&nbsp;<img src='im/no_stock.gif' title='".A6."'>" : "";
                $vis = ($produit['products_visible']=="no")? "&nbsp;<img src='im/eye.gif' title='".A5."'>" : "";
                $opt = ($produit['products_options']=="yes")? "&nbsp;<img src='im/option.gif' title='".str_replace("<br>"," - ",A7)."'>" : "&nbsp;&nbsp;&nbsp;&nbsp;";
                ...
                $ProdNameProdList = (strlen($produit['products_name_'.$lang])>=40)? substr($produit['products_name_'.$lang],0,40)."..." : $produit['products_name_'.$lang];
                   if($produit['products_visible']=='yes') {
                     print "<br>".espace3($rang3)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$opt."&nbsp;<a href='opties_maken.php?id=".$produit['products_id']."'>".$ProdNameProdList."</a> <span style='color:#999999'>- [ID:<b>".$produit['products_id']."</b> | Ref:<b>".$produit['products_ref']."</b>]</span>".$rupture.$vis.$do.$noStock;
                   }
                   else {
                     print "<br>".espace3($rang3)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='color:red'>".$ProdNameProdList."</span>".$rupture.$vis.$do.$opt.$noStock;
                   }
               }
       print "</td>";
...
<p align="center" class="largeBold"><?php print AJOUTER_OPTION;?></p>
...
<div align="center">-- <?php print A1;?> --</div>
...
<tr>
<form action="opties_maken.php" method="GET" target='main'>
<td align="center">
<?php
print  "<select name='id'>";
while ($produit = mysql_fetch_array($prods)) {
           print "<option name='id' value='".$produit['products_id']."'>";
           if($produit['products_options']=="yes") $zul="  --> [".OPTO."]"; else $zul="";
           print $produit['products_name_'.$_SESSION['lang']]." <span style='color:#999999'>- [ID:<b>".$produit['products_id']."</b> | Ref:<b>".$produit['products_ref']."</b>]</span>".$zul;
           print "</option>";
}
print "</select>";
?>
...
while($message = mysql_fetch_array($result)) {
	...
	if($message['categories_visible']=='yes') $visible=A2; else $visible="<span style='color:red'><b>".A3."</b></span>";
...
print "<tr>";
print "<td height='19' align='center'><b>".A4."</b></td>";
recur($data,"0","0",$_SESSION['lang']);
print "</tr>";
print "</table>";

print "<br><center>";
print "<table border='0' cellpadding='2' cellspacing ='5' align='center' class='TABLE' width='700'><tr><td><left>";
print "<img src='im/no_stock.gif' align='absmiddle'> : ".A6."<br>";
print "<img src='im/download.gif' align='absmiddle'> : ".A8."<br>";
print "<img src='im/eye.gif' align='absmiddle'> : ".A5."<br>";
print "<img src='im/option.gif' align='absmiddle'> : ".A7."<br>";

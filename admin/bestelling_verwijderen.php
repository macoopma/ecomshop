...
if(!IsSet($_GET['page'])) {
        ...
        echo A2."<br><br>";
        echo "<a href='bestelling_verwijderen.php?page=delete&id=".$_GET['id']."&yo=".$_GET['yo']."&jour1=".$_GET['jour1']."&mois1=".$_GET['mois1']."&an1=".$_GET['an1']."&jour2=".$_GET['jour2']."&mois2=".$_GET['mois2']."&an2=".$_GET['an2']."'><b>".A3."</b></a>";
        echo "&nbsp;|&nbsp;";

...
<form action="css_interface.php?action=write" method="POST" name="toto_1" enctype='multipart/form-data'>
<?php
if(!isset($_GET['action'])) {
...
<tr bgcolor="#FFFFFF">
<td colspan="3"><?php print A6;?> <input type="text" name="a10000" size="2" maxlength="2" class="vullen" value="<?php print str_replace("#","",$boum[49]);?>">&nbsp;&nbsp;&nbsp;px</td>
</tr>
...
<?php print AIMAGE;?>
			...
			<input type="text" size="40" name="a50000" class='vullen' value="<?php print str_replace("#","",$boum[48]);?>">&nbsp;(.gif,.jpg,.png)
			</div>
...
$config.="/*\r\n";
$config.="Font kleur artikelen en randen\r\n";
$config.="*/\r\n";
...
$config.="/*\r\n";
$config.="Menu css horizontaal met randen\r\n";
$config.="*/\r\n";
...
?>
  ...
  <tr>
    <td colspan="2"><br><div align="center"><b><a href="css_interface.php" target='main'><?php print A5;?></a></b></div></td>
  </tr>
  </table><br><br><br>
<?php
}

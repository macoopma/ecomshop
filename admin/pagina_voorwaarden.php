...
if(isset($_POST['action']) AND $_POST['action']=="ok") {
    ...
    $_POST['cond3'] = str_replace("'","&#146;",$_POST['cond3']);
    $update = mysql_query("UPDATE pages SET pages_cond1 = '".$_POST['cond1']."', pages_cond2 = '".$_POST['cond2']."', pages_cond3 = '".$_POST['cond3']."' WHERE pages_id='1'") or die (mysql_error());
...
<textarea cols="90" rows="15" name="cond3" value=""><?php print $result['pages_cond3'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=cond3" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond1" value=""><?php print $result['pages_cond1'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=cond1" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond2" value=""><?php print $result['pages_cond2'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=cond2" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
</table>
</form>

...
if(isset($_POST['action']) AND $_POST['action']=="ok") {
  ...
  $_POST['cond3'] = str_replace("'","&#146;",$_POST['cond3']);
  $update = mysql_query("UPDATE pages SET pages_aff1 = '".$_POST['cond1']."', pages_aff2 = '".$_POST['cond2']."', pages_aff3 = '".$_POST['cond3']."' WHERE pages_id='1'");
...
<textarea cols="90" rows="15" name="cond3" value=""><?php print $result['pages_aff3'];?></textarea>
</td>
<td valign="top" align="left">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=aff3" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond1" value=""><?php print $result['pages_aff1'];?></textarea>
</td>
<td valign="top" align="left">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=aff1" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond2" value=""><?php print $result['pages_aff2'];?></textarea>
</td>
<td valign="top" align="left">
<input type="submit" value="<?php print A5;?>" class="knop">
<br><a href="../bekijken.php?fromPage=aff2" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
</table>
</form>

...
<?php
$categQuery = mysql_query("SELECT export_auto_shopping FROM admin");
$categ = mysql_fetch_array($categQuery);

if(!empty($categ['export_auto_shopping'])) {
            $cat = $categ['export_auto_shopping'];
            $cat = explode("||", $categ['export_auto_shopping']);

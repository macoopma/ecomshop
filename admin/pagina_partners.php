...
if(isset($_POST['action']) AND $_POST['action']=="ok") {
  ...
  $_POST['cond3'] = str_replace("'","&#146;",$_POST['cond3']);
  $update = mysql_query("UPDATE pages SET pages_part1 = '".$_POST['cond1']."', pages_part2 = '".$_POST['cond2']."', pages_part3 = '".$_POST['cond3']."' WHERE pages_id='1'");
...
<textarea cols="90" rows="15" name="cond3" value=""><?php print $result['pages_part3'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" class="knop"value="<?php print A5;?>">
<br><a href="../bekijken.php?fromPage=part3" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond1" value=""><?php print $result['pages_part1'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" class="knop"value="<?php print A5;?>">
<br><a href="../bekijken.php?fromPage=part1" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
...
<textarea cols="90" rows="15" name="cond2" value=""><?php print $result['pages_part2'];?></textarea>
</td>
<td align="right" valign="top">
<input type="submit" class="knop"value="<?php print A5;?>">
<br><a href="../bekijken.php?fromPage=part2" target="_blank"><img src="im/voir.gif" border="0" title="<?php print VOIR;?>"></a>
</td>
</tr>
</table>
</form>

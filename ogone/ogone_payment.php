...
?>
    ...
    <td colspan="3" >
             ...
             <table width="99%" align="center" border="0" cellspacing="0" cellpadding="5" class="TABLEBottomPage">
              <tr height="32">
                <td><b><img src="../im/accueil.gif" align="TEXTTOP">&nbsp;<a href="../cataloog.php" ><?php print maj(HOME);?></a> | OGONE |</b>
               </td>
              </tr>
             </table>
...
if(!isset($_GET['add'])) {
	...
	invoice_display($_SESSION['clientCountry'],"TABLE1","../",$_SESSION['shippingId']);
         ...
         /* Ogone */
            ...
            print "<tr><td>";
            print "<u><b>".PAIEMENTOGONE."</b></u><br><br>";
...
<!-- FORMULIER OGONE -->
<FORM METHOD="post" ACTION="https://secure.ogone.com/ncol/<?php print $ogoneMode;?>/orderstandard.asp" id=form1 name=form1>
<INPUT type="hidden" NAME="PSPID" value="<?php print $ogonePspid; // Utilisateur Ogone?>">
...
<!-- lay out information -->
<INPUT type="hidden" NAME="TITLE" VALUE="<?php print $store_name;?>">
...
<input type="image" src="../im/logo_ogone.gif" id="submit2" value="submit2">
</form>
<!-- EINDE FORMULIER OGONE -->

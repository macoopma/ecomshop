...
if($lang==1) {$titleZ = $store_name." : Ventes Flash"; $language="fr-fr"; $noPromo ="Vente flash terminée !  Revenez nous voir trés bientôt...";}
if($lang==2) {$titleZ = $store_name." : Flash Sales"; $language="en-us"; $noPromo ="Flash sales are finished for now !  Come back to us soon...";}
if($lang==3) {$titleZ = $store_name." : Flash verkoop"; $language="nl"; $noPromo ="Er is op dit ogenblik geen flash verkoop, kom later even terug...";}
...
$query.= "WHERE TO_DAYS(s.specials_first_day) <= TO_DAYS(NOW()) ";
$query.= "AND TO_DAYS(s.specials_last_day) >= TO_DAYS(NOW()) \n";
if($displayOutOfStock=="non") {$query.= " AND p.products_qt>'0' ";}
if($activeSeuilPromo=="oui") $query.= " AND (TO_DAYS(s.specials_last_day)-TO_DAYS(NOW())) <= '".$seuilPromo."' ";
$query.= "AND s.specials_visible='yes' ";
...
$query.= "ORDER BY s.specials_last_day ASC";
...
$xml.= "<link>".$domaineURL."/cataloog.php?lang=".$lang."</link>\r\n";

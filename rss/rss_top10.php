...
if($lang==1) {$titleZ = $store_name." : Meilleures ventes"; $language="fr-fr"; $noPromo ="Prochainement...";}
if($lang==2) {$titleZ = $store_name." : TOP10"; $language="en-us"; $noPromo ="Top10 desactivated...";}
if($lang==3) {$titleZ = $store_name." : Meest verkocht"; $language="nl"; $noPromo ="Niet actief...";}
...
$query.= "WHERE p.products_ref != 'GC100' ";
$query.= "AND p.products_visible='yes' ";
$query.= "AND p.products_forsale = 'yes' \n";
$query.= "ORDER BY p.products_viewed DESC LIMIT 0,10";

...
if($lang==1) {$titleZ = $store_name." : Promotions"; $language="fr-fr"; $noPromo ="Pas de Promotions pour le moment...!";}
if($lang==2) {$titleZ = $store_name." : Specials"; $language="en-us"; $noPromo ="No specials for now...!";}
if($lang==3) {$titleZ = $store_name." : Promoties"; $language="nl"; $noPromo ="Er zijn op dit ogenblik geen promoties";}
